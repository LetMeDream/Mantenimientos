<?php
        ...
        while($row = mysqli_fetch_array($res)){
            ...
            $pdf->SetXY(18, 10); // set the position of the box
            $pdf->Cell(40,77,utf8_encode($row['tipoDeEquipo']), 0, 1 ,'C', 0);
            /** Fecha */
            $pdf->SetFont('Arial','B',10);
            $pdf->SetXY(166, 47); // set the position of the box
            ...
            /** Horas en fecha */
            $pdf->SetFont('Arial','B',10);
            $pdf->SetXY(20, 50.5); // set the position of the box
            $pdf->Cell(60,10,utf8_encode( $row['kilometrajeEnFecha']), 0, 1, 'C', 0);
            /** Device Id */
            $pdf->SetFont('Arial','B',10);
            $pdf->SetXY(18, 47); // set the position of the box
            $pdf->Cell(60,10,utf8_encode('000' . $row['deviceId']), 0, 1, 'C', 0);
